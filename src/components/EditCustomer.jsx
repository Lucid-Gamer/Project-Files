...
export default function EditCustomer(){
      ...
      useEffect(() => {
        axios.get(`http://localhost:8081/customer/get/${id}`).then((res)=>{
      ...
      const updateCustomer = (e) =>{
        e.preventDefault();
        axios.post(`http://localhost:8081/customer/update/${id}`, customer)
        .then((res)=>{
          ...
          <Card className="card col-md-6 offset-md-3 mt-5 bg-dark">
            ...
            <Card.Body>
              <form className="form-group" onSubmit={(e)=> updateCustomer(e)}>
                ...
                <br></br>
                <div>
                  <FloatingLabel controlId="floatingInput" label="Gender" className="form">
                    <Form.Control type="text" placeholder="Gender" name="customerGender" value={customer.customerGender} onChange={(e)=>handleChange(e)}/>
                  </FloatingLabel>
                </div>
                <br></br>
                <div>
                ...
                <div>
                  <FloatingLabel controlId="floatingInput" label="DOB" className="form-label" >
                    <Form.Control type="text" placeholder="DOB" name="dob" value={(customer.dob)} onChange={(e)=>handleChange(e)} />
                  </FloatingLabel>
                </div>
                <br></br>
